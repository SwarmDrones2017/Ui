            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (event.getClipData().getDescription().getLabel().equals("Drone1")) {
                        ...
                        D1ProxRedBot.setY(y + 46 - D1ProxRedBot.getHeight() / 2);
                        D1ProxOrBot.setX(x - D1ProxOrBot.getWidth() / 2);
                        D1ProxOrBot.setY(y + 56 - D1ProxOrBot.getHeight() / 2);
                        D1ProxJauBot.setX(x - D1ProxJauBot.getWidth() / 2);
                        D1ProxJauBot.setY(y + 66 - D1ProxJauBot.getHeight() / 2);
                        D1ProxRedTop.setX(x - D1ProxRedTop.getWidth() / 2);
                        D1ProxRedTop.setY(y - 50 - D1ProxRedTop.getHeight() / 2);
                        D1ProxOrTop.setX(x - D1ProxOrTop.getWidth() / 2);
                        D1ProxOrTop.setY(y - 60 - D1ProxOrTop.getHeight() / 2);
                        D1ProxJauTop.setX(x - D1ProxJauTop.getWidth() / 2);
                        D1ProxJauTop.setY(y - 70 - D1ProxJauTop.getHeight() / 2);
                        D1ProxRedRight.setX(x + 45 - D1ProxRedRight.getWidth() / 2);
                        D1ProxRedRight.setY(y - D1ProxRedRight.getHeight() / 2);
                        D1ProxOrRight.setX(x + 55 - D1ProxOrRight.getWidth() / 2);
                        D1ProxOrRight.setY(y - D1ProxOrRight.getHeight() / 2);
                        D1ProxJauRight.setX(x + 65 - D1ProxJauRight.getWidth() / 2);
                        D1ProxJauRight.setY(y - D1ProxJauRight.getHeight() / 2);
                        D1ProxRedLeft.setX(x - 50 - D1ProxRedLeft.getWidth() / 2);
                        D1ProxRedLeft.setY(y - D1ProxRedLeft.getHeight() / 2);
                        D1ProxOrLeft.setX(x - 60 - D1ProxOrLeft.getWidth() / 2);
                        D1ProxOrLeft.setY(y - D1ProxOrLeft.getHeight() / 2);
                        D1ProxJauLeft.setX(x - 70 - D1ProxJauLeft.getWidth() / 2);
                    ...
                    if (event.getClipData().getDescription().getLabel().equals("Drone2")) {
                        ...
                        D2ProxRedBot.setY(y + 46 - D2ProxRedBot.getHeight() / 2);
                        D2ProxOrBot.setX(x - D2ProxOrBot.getWidth() / 2);
                        D2ProxOrBot.setY(y + 56 - D2ProxOrBot.getHeight() / 2);
                        D2ProxJauBot.setX(x - D2ProxJauBot.getWidth() / 2);
                        D2ProxJauBot.setY(y + 66 - D2ProxJauBot.getHeight() / 2);
                        D2ProxRedTop.setX(x - D2ProxRedTop.getWidth() / 2);
                        D2ProxRedTop.setY(y - 50 - D2ProxRedTop.getHeight() / 2);
                        D2ProxOrTop.setX(x - D2ProxOrTop.getWidth() / 2);
                        D2ProxOrTop.setY(y - 60 - D2ProxOrTop.getHeight() / 2);
                        D2ProxJauTop.setX(x - D2ProxJauTop.getWidth() / 2);
                        D2ProxJauTop.setY(y - 70 - D2ProxJauTop.getHeight() / 2);
                        D2ProxRedRight.setX(x + 45 - D2ProxRedRight.getWidth() / 2);
                        D2ProxRedRight.setY(y - D2ProxRedRight.getHeight() / 2);
                        D2ProxOrRight.setX(x + 55 - D2ProxOrRight.getWidth() / 2);
                        D2ProxOrRight.setY(y - D2ProxOrRight.getHeight() / 2);
                        D2ProxJauRight.setX(x + 65 - D2ProxJauRight.getWidth() / 2);
                        D2ProxJauRight.setY(y - D2ProxJauRight.getHeight() / 2);
                        D2ProxRedLeft.setX(x - 50 - D2ProxRedLeft.getWidth() / 2);
                        D2ProxRedLeft.setY(y - D2ProxRedLeft.getHeight() / 2);
                        D2ProxOrLeft.setX(x - 60 - D2ProxOrLeft.getWidth() / 2);
                        D2ProxOrLeft.setY(y - D2ProxOrLeft.getHeight() / 2);
                        D2ProxJauLeft.setX(x - 70 - D2ProxJauLeft.getWidth() / 2);
                    ...
                    if (event.getClipData().getDescription().getLabel().equals("Drone3")) {
                        ...
                        D3ProxRedBot.setY(y + 46 - D3ProxRedBot.getHeight() / 2);
                        D3ProxOrBot.setX(x - D3ProxOrBot.getWidth() / 2);
                        D3ProxOrBot.setY(y + 56 - D3ProxOrBot.getHeight() / 2);
                        D3ProxJauBot.setX(x - D3ProxJauBot.getWidth() / 2);
                        D3ProxJauBot.setY(y + 66 - D3ProxJauBot.getHeight() / 2);
                        D3ProxRedTop.setX(x - D3ProxRedTop.getWidth() / 2);
                        D3ProxRedTop.setY(y - 50 - D3ProxRedTop.getHeight() / 2);
                        D3ProxOrTop.setX(x - D3ProxOrTop.getWidth() / 2);
                        D3ProxOrTop.setY(y - 60 - D3ProxOrTop.getHeight() / 2);
                        D3ProxJauTop.setX(x - D3ProxJauTop.getWidth() / 2);
                        D3ProxJauTop.setY(y - 70 - D3ProxJauTop.getHeight() / 2);
                        D3ProxRedRight.setX(x + 45 - D3ProxRedRight.getWidth() / 2);
                        D3ProxRedRight.setY(y - D3ProxRedRight.getHeight() / 2);
                        D3ProxOrRight.setX(x + 55 - D3ProxOrRight.getWidth() / 2);
                        D3ProxOrRight.setY(y - D3ProxOrRight.getHeight() / 2);
                        D3ProxJauRight.setX(x + 65 - D3ProxJauRight.getWidth() / 2);
                        D3ProxJauRight.setY(y - D3ProxJauRight.getHeight() / 2);
                        D3ProxRedLeft.setX(x - 50 - D3ProxRedLeft.getWidth() / 2);
                        D3ProxRedLeft.setY(y - D3ProxRedLeft.getHeight() / 2);
                        D3ProxOrLeft.setX(x - 60 - D3ProxOrLeft.getWidth() / 2);
                        D3ProxOrLeft.setY(y - D3ProxOrLeft.getHeight() / 2);
                        D3ProxJauLeft.setX(x - 70 - D3ProxJauLeft.getWidth() / 2);
